...
export default function App() {
  const [view, setView] = useState<"learner" | "parent" | "demo">("learner");
  ...
  return <div className="app-shell">
    <header className="topbar">
      ...
      <nav aria-label="Choose experience"><button className={view === "learner" ? "active" : ""} onClick={() => setView("learner")}>Learner</button><button className={view === "demo" ? "active" : ""} onClick={() => setView("demo")}>Explore packs</button><button className={view === "parent" ? "active" : ""} onClick={() => setView("parent")}>Parent preview</button></nav>
    ...
    </div> : view === "demo" ? <DemoPack /> : <ParentView refreshKey={refreshKey} />}
