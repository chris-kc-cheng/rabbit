...
const bankFields: FieldRow[] = [
  { path: "schemaVersion", required: "Yes", accepted: "2", meaning: "Rabbit content-contract version. No other value is accepted." },
