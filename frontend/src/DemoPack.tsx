...
export function DemoPack() {
  ...
  return <main className={`demo-page demo-${subject}`}>
    <header className="demo-intro"><p className="eyebrow">Explore the prototype</p><h1>Three ways to get curious.</h1><p>Try a sample from each subject. Your answers are checked by Rabbit when you press Check answer.</p></header>
