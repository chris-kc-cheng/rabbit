...
export function DemoParentView() {
  ...
  const downloadWorksheet = async () => {
    ...
    try {
      ...
      setNotice(caught instanceof Error ? caught.message : "Could not make the worksheet");
    } finally {
      setGenerating(false);
    }
  };
