...
- [x] In-app and written JSON schema documentation, per-type examples, an AI-ready schema download, parameter and formula boundaries, a live fraction-bar playground, and reusable Discover Canada AI
